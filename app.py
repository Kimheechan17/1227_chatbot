...
characters = {
    "짱구": ["감자머리", "https://upload.wikimedia.org/wikipedia/ko/4/4a/%EC%8B%A0%EC%A7%B1%EA%B5%AC.png"],
    "도라에몽": ["만능주머니", "https://i.namu.wiki/i/63SUjoeSkbefiyy1x19TThehoFExxifYSYHERHsI6YVWv2yCg1e4TnR7cqKmOUFDyeqsuW27d8gK6gyrJ3LPTQ.webp"]
}


# 사용자 아바타 이미지 URL
user_avatar_url = "https://i.namu.wiki/i/Fl6BXmLvs7kEmaEasXcLQsE-haRSwgfui9_PySLpDNArp6lXWpBSyb0cUIW4Qn27sPkCx12P3O6S0X4hFLjdMxHh9ArRCRWr0B3pQI4YunZb1fRObAJeXPHz4jXpfsLnPILKUTv7gEhDHn13odsuZA.webp"
...
def generate_conversation(language, character, user_input):
    ...
    [짱구]: [https://ko.wikipedia.org/wiki/%EC%8B%A0%EC%A7%B1%EA%B5%AC].
    [도라에몽]: [https://namu.wiki/w/%EB%8F%84%EB%9D%BC%EC%97%90%EB%AA%BD], 말투는 반말로 해주세요.
